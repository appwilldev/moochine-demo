...
rm -rf redis-2.8.3.tar.gz redis-2.8.3
...
rm -rf ngx_openresty-1.4.3.9.tar.gz ngx_openresty-1.4.3.9
wget http://agentzh.org/misc/nginx/ngx_openresty-1.4.3.9.tar.gz
tar xzvf ngx_openresty-1.4.3.9.tar.gz
