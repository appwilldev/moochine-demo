...
rm -rf postgresql-9.4.1.tar.gz postgresql-9.4.1
wget http://ftp.postgresql.org/pub/source/v9.4.1/postgresql-9.4.1.tar.gz
tar vfxz postgresql-9.4.1.tar.gz
cd postgresql-9.4.1
./configure
make -j6
make install
...
rm -rf ngx_openresty-1.7.10.1.tar.gz ngx_openresty-1.7.10.1
wget http://agentzh.org/misc/nginx/ngx_openresty-1.7.10.1.tar.gz
