...
rm -rf postgresql-9.2.5.tar.gz postgresql-9.2.5
wget http://ftp.postgresql.org/pub/source/v9.2.5/postgresql-9.2.5.tar.gz
tar vfxz postgresql-9.2.5.tar.gz
cd postgresql-9.2.5
./configure
make -j6
make install
...
rm -rf ngx_openresty-1.4.3.1.tar.gz ngx_openresty-1.4.3.1
wget http://agentzh.org/misc/nginx/ngx_openresty-1.4.3.1.tar.gz
tar xzvf ngx_openresty-1.4.3.1.tar.gz
