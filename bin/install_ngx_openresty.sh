...
rm -rf ngx_openresty-1.2.7.6.tar.gz ngx_openresty-1.2.7.6
wget http://agentzh.org/misc/nginx/ngx_openresty-1.2.7.6.tar.gz
tar xzvf ngx_openresty-1.2.7.6.tar.gz
