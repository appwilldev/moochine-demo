...
rm -rf ngx_openresty-1.2.7.5.tar.gz ngx_openresty-1.2.7.5
wget http://agentzh.org/misc/nginx/ngx_openresty-1.2.7.5.tar.gz
tar xzvf ngx_openresty-1.2.7.5.tar.gz
cd ngx_openresty-1.2.7.5
