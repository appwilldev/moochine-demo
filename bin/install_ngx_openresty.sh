...
rm -rf ngx_openresty-1.4.3.3.tar.gz ngx_openresty-1.4.3.3
wget http://agentzh.org/misc/nginx/ngx_openresty-1.4.3.3.tar.gz
tar xzvf ngx_openresty-1.4.3.3.tar.gz
