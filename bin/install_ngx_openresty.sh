...
rm -rf ngx_openresty-1.2.8.1.tar.gz ngx_openresty-1.2.8.1
wget http://agentzh.org/misc/nginx/ngx_openresty-1.2.8.1.tar.gz
tar xzvf ngx_openresty-1.2.8.1.tar.gz
